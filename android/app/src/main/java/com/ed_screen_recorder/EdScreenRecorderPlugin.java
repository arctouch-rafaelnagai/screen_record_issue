package com.ed_screen_recorder;
...
public class EdScreenRecorderPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler,
    ...
    public static EdScreenRecorderPlugin instance;
...
//    private FlutterPluginBinding flutterPluginBinding;
    ...
    public static void registerWith(BinaryMessenger messenger, Activity activity) {
        instance = new EdScreenRecorderPlugin();
        instance.messenger = messenger;
        instance.activity = activity;
        instance.setupChannels();
        instance.hbRecorder = new HBRecorder(activity.getApplicationContext(), instance);
    ...
    private void setOutputPath(boolean addTimeCode, String fileName, String dirPathToSave) throws IOException {
        ...
        if (dirPathToSave != null && !dirPathToSave.equals("")) {
            ...
            hbRecorder.setOutputPath(
                    activity.getApplicationContext().getExternalCacheDir().getAbsolutePath());
            filePath = activity.getApplicationContext().getExternalCacheDir().getAbsolutePath() + "/"
